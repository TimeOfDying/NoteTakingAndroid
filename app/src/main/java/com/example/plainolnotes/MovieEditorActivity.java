...
public class MovieEditorActivity extends ActionBarActivity
    ...
    private EditText editorNotePlace;
    private EditText editorNoteMovieName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editorNoteDate.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(MovieEditorActivity.this, MovieEditorActivity.this, year, month, day);
    ...
    private void finishEditing() {
        ...
        switch (action) {
            case Intent.ACTION_INSERT:
                if (newName.length() == 0 && newDate.length() == 0 && newPlace.length() == 0 && newMovieName.length() == 0) {
                    setResult(RESULT_CANCELED);
                } else {
                    insertNote(newName, newText, newDate, newPriority, newPlace, newMovieName);
                }
                break;
    ...
    public void onDateSet(DatePicker datePicker, int i, int i1, int i2)
    {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(MovieEditorActivity.this, MovieEditorActivity.this, hour, minute, DateFormat.is24HourFormat(this));
