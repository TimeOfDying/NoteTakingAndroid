...
public class ShoppingEditorActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editorNoteDate.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(ShoppingEditorActivity.this, ShoppingEditorActivity.this, year, month, day);
        ...
        switch (action) {
            case Intent.ACTION_INSERT:
                if (newText.length() == 0) {
                    ...
                    insertNote(newName, newText, newDate, newPriority);
                }
                break;
            case Intent.ACTION_EDIT:
                if (newText.length() == 0 && newName.length() == 0) {
                    ...
                    updateNote(newName, newText, newDate, newPriority);
                }
    ...
    private void pinNote()
    {
        ...
        values.put(Note.NOTE_CATEGORY, "Shopping");
    ...
    private void updateNote(String noteName, String noteText, String noteDate, int notePriority) {
        ContentValues values = new ContentValues();
    ...
    private void insertNote(String noteName, String noteText, String noteDate, int notePriority) {
        Note note = new Note();
    ...
    public void onDateSet(DatePicker datePicker, int i, int i1, int i2)
    {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(ShoppingEditorActivity.this, ShoppingEditorActivity.this, hour, minute, DateFormat.is24HourFormat(this));
